...
public class MySQLContextImpl implements SqlContext {

	private JdbcTemplate jdbcTemplate;

	private Map<String, String> sqlFragments = new HashMap<>();

	public MySQLContextImpl(JdbcTemplate jdbcTemplate) {
		super();
	...
	public SqlWhereStep selectFrom(String sql) {
		...
		return new MySQLWhereStep(jdbcTemplate, sqlFragments);
	}
