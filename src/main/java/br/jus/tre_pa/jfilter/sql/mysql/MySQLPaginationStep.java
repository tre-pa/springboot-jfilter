...
public class MySQLPaginationStep implements SqlPaginationStep {

	private JdbcTemplate jdbcTemplate;

	private Map<String, String> sqlFragments = new HashMap<>();

	public MySQLPaginationStep(JdbcTemplate jdbcTemplate, Map<String, String> sqlFragments) {
		super();
	...
	public SqlPageableSelectStep limit(Pageable pageable) {
		...
		if (pageable.getPageNumber() == 0) {
			...
			return new MySQLPageableSelectStep(jdbcTemplate, sqlFragments, pageable);
		}
		// @formatter:off
